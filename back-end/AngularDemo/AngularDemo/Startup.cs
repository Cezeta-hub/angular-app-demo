...
namespace CEZ.AngularDemo
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "CEZ.AngularDemo", Version = "v1" });
            ...
            {
                options.UseSqlServer(Configuration.GetConnectionString("AngularDemoDB"));
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "CEZ.AngularDemo v1"));
            }
